...
sprog.webgl.uniforms.ensure_uniform_present_BANG_ = (function sprog$webgl$uniforms$ensure_uniform_present_BANG_(gl,p__31280,uniform_name){
var map__31281 = p__31280;
var map__31281__$1 = cljs.core.__destructure_map(map__31281);
var program = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31281__$1,new cljs.core.Keyword(null,"program","program",781564284));
var uniform_locations_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31281__$1,new cljs.core.Keyword(null,"uniform-locations-atom","uniform-locations-atom",-1081551033));
if(cljs.core.not((function (){var fexpr__31283 = cljs.core.deref(uniform_locations_atom);
return (fexpr__31283.cljs$core$IFn$_invoke$arity$1 ? fexpr__31283.cljs$core$IFn$_invoke$arity$1(uniform_name) : fexpr__31283.call(null,uniform_name));
})())){
...
sprog.webgl.uniforms.convert_bool = (function sprog$webgl$uniforms$convert_bool(p1__31323_SHARP_){
if(cljs.core.boolean_QMARK_(p1__31323_SHARP_)){
if(p1__31323_SHARP_){
...
sprog.webgl.uniforms.set_sprog_uniforms_BANG_ = (function sprog$webgl$uniforms$set_sprog_uniforms_BANG_(gl,p__31355,uniforms){
var map__31356 = p__31355;
var map__31356__$1 = cljs.core.__destructure_map(map__31356);
var sprog__$1 = map__31356__$1;
var uniform_type_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31356__$1,new cljs.core.Keyword(null,"uniform-type-map","uniform-type-map",-1681076371));
var uniform_locations_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31356__$1,new cljs.core.Keyword(null,"uniform-locations-atom","uniform-locations-atom",-1081551033));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (texture_index,p__31357){
var vec__31361 = p__31357;
var uniform_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31361,(0),null);
...
if(cljs.core.truth_((function (){var fexpr__31365 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["usampler2D",null,"usampler3D",null,"sampler3D",null,"sampler2D",null], null), null);
return (fexpr__31365.cljs$core$IFn$_invoke$arity$1 ? fexpr__31365.cljs$core$IFn$_invoke$arity$1(uniform_type) : fexpr__31365.call(null,uniform_type));
})())){
gl.activeTexture((gl.TEXTURE0 + texture_index));

gl.bindTexture((cljs.core.truth_((function (){var fexpr__31366 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["usampler3D",null,"sampler3D",null], null), null);
return (fexpr__31366.cljs$core$IFn$_invoke$arity$1 ? fexpr__31366.cljs$core$IFn$_invoke$arity$1(uniform_type) : fexpr__31366.call(null,uniform_type));
})())?gl.TEXTURE_3D:gl.TEXTURE_2D),value);

sprog.webgl.uniforms.set_uniform_int_BANG_(gl,(function (){var fexpr__31367 = cljs.core.deref(uniform_locations_atom);
return (fexpr__31367.cljs$core$IFn$_invoke$arity$1 ? fexpr__31367.cljs$core$IFn$_invoke$arity$1(uniform_glsl_name) : fexpr__31367.call(null,uniform_glsl_name));
})(),texture_index);

return (texture_index + (1));
} else {
var G__31436_31583 = gl;
var G__31437_31584 = (function (){var fexpr__31440 = cljs.core.deref(uniform_locations_atom);
return (fexpr__31440.cljs$core$IFn$_invoke$arity$1 ? fexpr__31440.cljs$core$IFn$_invoke$arity$1(uniform_glsl_name) : fexpr__31440.call(null,uniform_glsl_name));
})();
var G__31438_31585 = value;
var fexpr__31435_31586 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("float",uniform_type))?sprog.webgl.uniforms.set_uniform_float_BANG_:(cljs.core.truth_(cljs.core.re_find(/float\[[0-9]+\]/,uniform_type))?sprog.webgl.uniforms.set_uniform_float_array_BANG_:(cljs.core.truth_((function (){var or__5043__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("vec2",uniform_type);
if(or__5043__auto__){
...
(fexpr__31435_31586.cljs$core$IFn$_invoke$arity$3 ? fexpr__31435_31586.cljs$core$IFn$_invoke$arity$3(G__31436_31583,G__31437_31584,G__31438_31585) : fexpr__31435_31586.call(null,G__31436_31583,G__31437_31584,G__31438_31585));
